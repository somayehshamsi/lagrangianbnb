...
class MSTNode(Node):
    ...
    def __init__(self, edges, num_nodes, budget, fixed_edges=set(), excluded_edges=set(), branched_edges=set(),
                 initial_lambda=0.11, inherit_lambda=False, branching_rule="random_mst",
                 ...
                 use_bisection=False, max_iter=11, verbose=False, depth=0,
        ...
        self.initial_lambda = initial_lambda if initial_lambda is not None else 0.11
        ...
        if not must_prune_fixed:
            ...
            if not prune_fixed:
                fixed_child = MSTNode(
                    ...
                    initial_lambda=solver.best_lambda if self.inherit_lambda else 0.11,
    ...
    def simulate_branching_bound(self, edge, fix_edge: bool = True, max_iters: int = 10):
        ...
        with self._sb_pool.borrow() as sim_solver:
            ...
            sim_solver.reset(
                ...
                initial_lambda=getattr(self.lagrangian_solver, "best_lambda", getattr(self, "initial_lambda", 0.11)),
