...
class MSTNode(Node):
    ...
    def calculate_strong_branching_score(self, edge):
        ...
        fixed_lower_bound = self.simulate_branching_bound(edge, fix_edge=True, max_iters=3)
        ...
        excluded_lower_bound = self.simulate_branching_bound(edge, fix_edge=False, max_iters=3)
