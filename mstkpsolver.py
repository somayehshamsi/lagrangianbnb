...
if __name__ == "__main__":
    ...
    if best_solution:
        ...
        # for edge in best_solution.mst_edges:
        #     print(edge)
        # best_feasible_edges is the tree achieving the reported bound;
        # mst_edges is the node's last Lagrangian tree and is usually over budget.
        _edges = (best_solution if isinstance(best_solution, list)
                  else (getattr(best_solution, "best_feasible_edges", None)
